<?php /*Template Name: DieretoriaAdministrativa */?>
...
<div class="container">
    ...
    <div class="jow">
        <div class="item col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4">
            <section id="card-ps">
                <div class="img_presidente" id="fotoPresidente">
                    <?php the_post_thumbnail(); ?>
                </div>
                <div class="paralelograma text-white">
                    <ul>
                        ...
                        <li id="xxx">
                            <?php echo get_post_meta($post->ID, 'nome', true); ?>
                        </li>
                        <li id="conteudo">
                            <?php echo get_post_meta($post->ID, 'formacao', true); ?>
                        </li>
                    </ul>
                </div>
            </section>
        ...
        <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4" id="ladoDir">
            <div id="organogramaDU">
                <div id="DiretU">
                    <p>
                        <?php echo get_post_meta($post->ID, 'diretoria', true); ?>
                    </p>
                </div>
                <div id="DEINFRA">
                    <p>DEINFRA</p>
